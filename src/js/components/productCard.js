...
export function createProductCard(product) {
    return `
      <div class="bg-white text-black rounded-xl p-6 shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-200 flex flex-col justify-between" data-product-id="${product.id}">
      <div>
      ...
      ${product.coupons && product.coupons.includes('B2GO') 
        ...
        <div class="flex flex-col gap-2  sm:justify-between sm:items-center mt-4">
